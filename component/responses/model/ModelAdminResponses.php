...
/**
 * Description of ModelAdminResponses
 *
 * @author s.novoseletskiy
 */
class ModelAdminResponses extends ModelAdmin {
     ...
     * @return type
     */
    public function GetItems($filter = 0) {
    ...
    public function GetAdminItem($idItem) {
        ...
        $params['value']['url'] = $this->GetModelUrl()->GetItemByParam(
                    $this->ToBase(app::I()->_REQUEST['module']), $idItem
        );
