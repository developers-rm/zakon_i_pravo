...
require($_SERVER['DOCUMENT_ROOT'] . '/component/main/lib/Image transform/PEAR.php');
//require($_SERVER['DOCUMENT_ROOT'] . '/component/main/lib/Image transform/Transform/Driver/GD.php');
//require('PEAR5.php');
...
class Image_Transform
{
    ...
    function &factory($driver = '')
    {
        ...
        $file = $_SERVER['DOCUMENT_ROOT'] . '/component/main/lib/Image transform/Transform/Driver/' . $driver . '.php';
